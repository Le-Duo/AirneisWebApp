        ...
        <header>
          <Navbar expand={false} className="justify-content-between">
            <Container>
              <LinkContainer to="/">
                <NavbarBrand>
                  <img src="/images/airneis.svg" alt="logo" style={{ maxWidth: '40px', height: 'auto', padding: '4px' }} />
                </NavbarBrand>
              </LinkContainer>
              <div className="d-flex align-items-center">
                <Button variant={mode} onClick={() => (window.location.href = '/search')} className="me-auto">
                  <i className="fa-sharp fa-solid fa-search"></i>
                </Button>
                <Button variant={mode} onClick={() => (window.location.href = '/cart')} className="ms-2">
                ...
                <Button variant={mode} onClick={switchModeHandler} className="ms-2">
                  <i className={mode === 'light' ? 'fa-sharp fa-solid fa-sun' : 'fa-sharp fa-solid fa-moon'}></i>
                </Button>
              ...
              >
                <Offcanvas.Header closeButton>
                  <Offcanvas.Title id="offcanvasNavbarLabel">{userInfo ? <span>Halo, {userInfo.name}!</span> : <span>Menu</span>}</Offcanvas.Title>
                </Offcanvas.Header>
                <Offcanvas.Body>
                      ...
                      <>
                        {userInfo.isAdmin && (
                          <React.Fragment>
                            ...
                            <Nav.Link as="div" className="my-2">
                            </Nav.Link>
                          </React.Fragment>
                        )}
              ...
              <div className="container pt-5">
                <div className="row">
                  <div className="col-6 col-md-2 mb-3">
                    ...
                    <ul className="nav flex-column">
                      <li className="nav-item mb-2">
                        <RouterLink to="/" className="nav-link p-0 text-body-secondary">
                          Home
                        </RouterLink>
                      </li>
                      <li className="nav-item mb-2">
                        <RouterLink to="/tos" className="nav-link p-0 text-body-secondary">
                          Terms of Services
                        </RouterLink>
                      </li>
                      <li className="nav-item mb-2">
                        <RouterLink to="/legal-notice" className="nav-link p-0 text-body-secondary">
                          Legal Notice
                        </RouterLink>
                      </li>
                      <li className="nav-item mb-2">
                        <RouterLink to="/contact" className="nav-link p-0 text-body-secondary">
                          Contact
                        </RouterLink>
                      </li>
                      <li className="nav-item mb-2">
                        <RouterLink to="/about" className="nav-link p-0 text-body-secondary">
                          About
                        </RouterLink>
                      </li>
                    </ul>
                  ...
                  <div className="col-6 col-md-2 mb-3">
                    ...
                    <ul className="nav flex-column">
                      <li className="nav-item mb-2">
                        <RouterLink to="/search" className="nav-link p-0 text-body-secondary">
                          Search
                        </RouterLink>
                      </li>
                      <li className="nav-item mb-2">
                        <RouterLink to="/cart" className="nav-link p-0 text-body-secondary">
                          Cart
                        </RouterLink>
                      </li>
                    </ul>
                ...
                <div className="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
                  ...
                  <ul className="list-unstyled d-flex">
                    <li className="ms-3">
                      <a className="link-body-emphasis" href="https://twitter.com/airneis">
                        <i className="fab fa-twitter"></i>
                      </a>
                    </li>
                    <li className="ms-3">
                      <a className="link-body-emphasis" href="https://instagram.com/airneis">
                        <i className="fab fa-instagram"></i>
                      </a>
                    </li>
                    <li className="ms-3">
                      <a className="link-body-emphasis" href="https://facebook.com/airneis">
