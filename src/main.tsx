...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route path="/" element={<App />}>
      ...
      <Route path="cart" element={<CartPage />} /> <Route path="/search" element={<SearchPage />} />
      ...
      <Route path="signup" element={<SignupPage />} /> <Route path="/password-reset-request" element={<PasswordResetRequest />} />
